...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="form-inline my-2 my-lg-0">
                        <ul class="navbar-nav mr-auto text-center mx-auto">
                            <li class="nav-item nav--btn mb-3 mb-lg-0 mt-3 mt-lg-0">
    ...
    <div class="container">
        <div class="mt-2 mb-5">
            <a href="../dashboard.php"> Home </a> / <a href="index.php"> Categories </a> / Create
        </div>
        <div class="row">
            <div class="col">
                ...
                <form class=" mx-auto bg--form p-5 rounded" method="POST" action="store.php">
                    ...
                    <div class="form-group">
                        <label for="title" require>Title</label>
